...
1. [Markdown For Typora](#markdown-for-typora)
    1. [Overview](#overview)
    2. [Block Elements](#block-elements)
        1. [Paragraph and line breaks](#paragraph-and-line-breaks)
        2. [Headers](#headers)
        3. [Blockquotes](#blockquotes)
        4. [Lists](#lists)
        5. [Task List](#task-list)
        6. [(Fenced) Code Blocks](#fenced-code-blocks)
        7. [Math Blocks](#math-blocks)
        8. [Tables](#tables)
        9. [Footnotes](#footnotes)
        10. [Horizontal Rules](#horizontal-rules)
        11. [YAML Front Matter](#yaml-front-matter)
        12. [Table of Contents (TOC)](#table-of-contents-toc)
    3. [Span Elements](#span-elements)
        1. [Links](#links)
        ...
        8. [Underlines](#underlines)
        9. [Emoji :smile:](#emoji-smile)
        10. [Inline Math](#inline-math)
        11. [Subscript](#subscript)
        12. [Superscript](#superscript)
        13. [Highlight](#highlight)
    4. [HTML](#html)
        1. [Embed Contents](#embed-contents)
        2. [Video](#video)
        3. [Other HTML Support](#other-html-support)
