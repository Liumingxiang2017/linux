...
- 普通用户： 1-65535
  - 伪(系统)用户：UID值1-499（rhel5或者6为1-499，rhel7为1-999），为了方便系统管理，满足相应系统进程文件属主的要求，不能登录,/sbin/nologin
  - 一般（普通）用户：UID值500-60000（rhel5或者6为500-65535，rhel7为1000-很大），普通用户具有有限权限，/bin/bash
